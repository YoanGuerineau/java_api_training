...
public class FireHandler implements CallHandler {
    ...
    public void handle( HttpExchange exchange ) throws IOException {
        ...
        if ( this.isMethodAllowed( exchange.getRequestMethod() ) ) {
            ...
            System.out.println( "Fire at: " + incomingFire.getColLetter() + incomingFire.getRow() + " -> " + body );
        }
        ...
        if ( consequence.shipLeft() && this.source instanceof NavyClient ) { ( (NavyClient)this.source ).nextMove(); }
    }
}
